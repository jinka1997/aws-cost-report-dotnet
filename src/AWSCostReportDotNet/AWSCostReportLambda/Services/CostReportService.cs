...
namespace AWSCostReportLambda.Services
{
	public class CostReportService
	{
		...
		public static async ValueTask<GetCostAndUsageResponse> GetByDate(DateTime start, DateTime end)
		{
		...
		public static IEnumerable<string> EditMessage(Dictionary<DateTime, IEnumerable<CostReportDetail>> details)
		{
		...
		//public IEnumerable<CostDetail> EditDetailsByResponse(GetCostAndUsageResponse response)
		//{
		...
		//	//return response.ResultsByTime.Select(x => new CostDetail()
		//	//{
		//	//	UsageDateString = x.TimePeriod.Start,
		//	//	ResourceType = x.Groups.First().Metrics.
